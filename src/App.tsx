...
import { Loader2, Zap, AlertTriangle, FileText, CheckCircle2, RotateCcw, Copy, Check, MessageSquare, TrendingUp, Shield, Sparkles, Wand2, Settings, X, Plus, Trash2 } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      const analysis = analyzeJD(text, ignoredWords);
      setResult(analysis);
      setAnalyzing(false);
    }, 300);
  };
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[80vh] flex flex-col">
            <div className="flex items-center justify-between p-4 border-b border-slate-200">
              <h2 className="text-lg font-bold text-slate-800">Company Dictionary</h2>
            ...
            <div className="p-4 space-y-4 flex-1 overflow-y-auto">
              <p className="text-sm text-slate-600">
                Add company-specific terms that should be ignored during bias detection (e.g., internal jargon, product names).
              </p>
